...
namespace web_payrolls.Models
{
    ...
    public partial class DB_Connection : DbContext
    {
        ...
        public virtual ObjectResult<GetAllTransferLocation_Result> GetAllTransferLocation(string bid, string companyId, string locationId, string product_type_Id, string pro_type, string product_id, string codeProduct, string barcode, string qrCode, string grade, string color, string sizes, string status, string dates, string endDate, string onCutLocationId)
        {
            var bidParameter = bid != null ?
                new ObjectParameter("bid", bid) :
                new ObjectParameter("bid", typeof(string));
            ...
            var onCutLocationIdParameter = onCutLocationId != null ?
                new ObjectParameter("onCutLocationId", onCutLocationId) :
                new ObjectParameter("onCutLocationId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllTransferLocation_Result>("GetAllTransferLocation", bidParameter, companyIdParameter, locationIdParameter, product_type_IdParameter, pro_typeParameter, product_idParameter, codeProductParameter, barcodeParameter, qrCodeParameter, gradeParameter, colorParameter, sizesParameter, statusParameter, datesParameter, endDateParameter, onCutLocationIdParameter);
        }
