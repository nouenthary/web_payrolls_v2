...
{
    public class StockProductCutBalanceController : Controller
    {
        // Connection
            ...
            )
        {
            ...
            var stockInProductCutBalance = _connection
                .GetAllStockInProductCutBalance
                    (
                        bid,
                        cid,
                        typeName,
                ...
                .Where(result => result.Pro_Type == "Processing")
                .ToList()
                .ToPagedList(pageIndex, defaultPage);;

            return PartialView(stockInProductCutBalance);
        }
    }
}